...
const MAX_NOTE_WEIGHT = exports.NOTE_DEDUCTIONS.M;
/**
 ...
 */
function calculateCategoryScore(noteWeights, totalInfractionsInCategory) {
    if (totalInfractionsInCategory <= 0)
        return 100;
    const perInfractionShare = 100 / totalInfractionsInCategory;
    const totalDeduction = noteWeights.reduce((acc, weight) => acc + (weight / MAX_NOTE_WEIGHT) * perInfractionShare, 0);
